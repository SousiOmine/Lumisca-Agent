...
export class LumiscaCore {
   ...
   * `mode` (optional) marks the prompt as generated by an agent mode:
   * the transcript then stores a ModeMessage (short text + badge in the
   * UI) instead of a plain user message. */
  startPrompt(
    id: string,
    text: string,
    images?: ImageContent[],
